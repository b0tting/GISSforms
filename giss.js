configuration = {
    ...
    'general': {
        'Verus Deus': 'They believe in the authentic gods and flat earth. The flooding of the Netherlands is seen as a punishment of God. Pray 4 times a day, dietary restrictions, 10% donation mandatory. You expect your roommate to comply with your laws of faith.',
        'The Frisian doctrine': 'Strict religion which sees the province of ‘Frisia (Friesland) as the center of religious origin. Prophet is John the Frisian. There are dress codes, no electronic devices allowed in the house. You expect your roommate to comply with your laws of faith.',
        'WeCAN': 'Care about the Netherlands. National political party. Has a majority in both the Senate and House of representatives and is therefore the ruling party of the Netherlands. In addition to wanting to leave the EU (Nexit) and the ban on Verus Deus, WeCAN wants (the remains of) the Netherlands to merge with Belgium and Luxembourg to create the Great-Netherlands.',
        'FFD': 'Forum for Freedom and Democracy. National political party. WeCANs main competitor. In addition to wanting a smaller government and standing for the protection of Dutch values, the party particularly wants to make it compulsory for immigrants to emigrate so that there is more room for the real Dutch. Climate skeptics.'
    },
    'housing': {
        'HA': {
